...
async def generate(interaction: discord.Interaction, name: str, string: str, silent: bool):
    if interaction.guild is not None:
        logging.info(f"Recieved string {string} from user {interaction.user.name} in guild {interaction.guild.name}")
    else:
        logging.info(f"Recieved string {string} from user {interaction.user.name}")
